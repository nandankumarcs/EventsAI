...
CORS_ALLOWED_ORIGINS = get_list(
    ...
    "http://127.0.0.1:1599,http://localhost:1599,http://127.0.0.1:5173,http://localhost:5173,http://127.0.0.1:5174,http://localhost:5174",
)
...
MIDDLEWARE = [
    ...
    "apps.core.middleware.PasswordCookieAuthMiddleware",
